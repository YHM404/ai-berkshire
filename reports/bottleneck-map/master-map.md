...
最后更新：2026-06-26 **机器人产业链瓶颈报告新增**：机器人产业链纳入瓶颈地图。结论：精密减速器为S级产业瓶颈，行星滚柱丝杠/高精密丝杠为A级偏S，六维力/力矩传感器为A级；但多数纯正标的估值红灯，投资动作以观察为主。报告：`reports/bottleneck-map/机器人产业链-bottleneck-20260626.md`。
---
...
## 机器人产业链瓶颈（2026-06-26新增）

### R1. 精密减速器（谐波/RV）【S级产业瓶颈；投资可买性黄/红】

- **超级趋势**：工业机器人确定性增长 + 人形机器人上行情景。IFR显示2024年全球工业机器人安装量542,076台，在役存量466.4万台；中国安装约295,000台/54%。
- **卡点**：高扭矩密度、低回差、长寿命、齿形/热处理/装配一致性，扩产验证周期长。
- **可交易标的**：Nabtesco（6268.T，RV减速器，约60%工业机器人份额）、Harmonic Drive Systems（6324.T，谐波）、绿的谐波（688017.SH，谐波）。
- **估值纪律**：Nabtesco约42x PE，10年25x PE退出需净利CAGR约5.4%；Harmonic Drive/绿的谐波估值红灯，不追高。
- **反面**：人形机器人订单尚早，Tesla/Optimus未官方披露供应商；中国供应商扩产可能带来价格战。
- **报告**：`reports/bottleneck-map/机器人产业链-bottleneck-20260626.md`。

### R2. 行星滚柱丝杠/高精密丝杠【A级偏S；投资可买性黄】

- **卡点**：线性执行器核心件，承载、效率、寿命、精密加工与一致性要求高。
- **可交易标的**：THK（6481.T）、北特科技（603009.SH）等；多数机器人收入尚未充分披露。
- **估值纪律**：THK正常化PE约86x；北特科技约127x PE，需等待量产收入进入财报。
- **反面**：扩产规划不是订单，样品验证不是利润。

### R3. 六维力/力矩传感器【A级；投资可买性黄】

- **卡点**：标定、解耦、温漂控制、长期稳定性，决定机器人接触式作业能力。
- **可交易标的**：柯力传感（603662.SH）、Novanta（NOVT/ATI）。
- **估值纪律**：柯力传感约62x PE，10年25x PE退出需净利CAGR约9.5%；Novanta约117x PE且上市主体不纯。
- **反面**：市场小、价格下降快、机器人收入占比披露不足。
...
| 2026-06-26 | **机器人产业链瓶颈报告新增** | 精密减速器S级、滚柱丝杠A级偏S、六维力传感器A级；多数纯正标的估值红灯，Nabtesco/柯力优先观察；生成 `机器人产业链-bottleneck-20260626.md`。 |
